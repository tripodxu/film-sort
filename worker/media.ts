...
export function allowedImage(raw: string): URL | null {
  try {
    ...
    return /^(?:img\d+\.doubanio\.com|m\.media-amazon\.com|ia\.media-imdb\.com|image\.tmdb\.org|[\w-]+\.music\.126\.net|upload\.wikimedia\.org|bkimg\.cdn\.bcebos\.com)$/.test(url.hostname) ? url : null;
  } catch { return null; }
}
