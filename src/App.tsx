...
export default function App() {
  ...
  function openCollection(next: MediaCollection) {
    setKind(next.kind); setCollection(next); setSelected(next.works.map((work) => work.id)); setTopN(Math.min(next.topN, next.works.length)); setRanking(null); navigateTo("setup");
  }
