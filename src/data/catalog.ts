import type { FilmList, FilmListKind, FilmListStatus, LocalizedText, Movie } from "../types";
...
const activeSeeds: readonly FilmListSeed[] = [
  {
    ...
    tagline: bi(
      "公认佳作，也会排出只属于你的答案",
      "Acclaimed classics, reordered by your own taste",
    ),
    recommendation: bi(
      "第一次整理电影审美，从这些熟悉的佳作开始",
      "A welcoming first list packed with familiar essentials",
    ),
    kind: "category",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "时间、梦境与执念，你更偏爱哪一种震撼",
      "Time, dreams and obsession: choose your kind of spectacle",
    ),
    recommendation: bi(
      "适合喜欢烧脑叙事与大银幕奇观的观众",
      "For fans of intricate stories and large-format spectacle",
    ),
    kind: "director",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "风、飞行与成长，重返那些温柔又坚定的世界",
      "Wind, flight and growing up in worlds both gentle and brave",
    ),
    recommendation: bi(
      "适合想在童年记忆与成年感悟之间做选择的人",
      "For choosing between childhood wonder and grown-up resonance",
    ),
    kind: "director",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "错过、相遇与遥远距离里的微光",
      "Longing, encounters and light across impossible distances",
    ),
    recommendation: bi(
      "适合偏爱青春情绪、城市风景与绚丽天空的观众",
      "For lovers of youthful longing, cityscapes and luminous skies",
    ),
    kind: "director",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "跨越地域与年代，排出你的华语电影坐标",
      "Map your Chinese-language cinema across eras and regions",
    ),
    recommendation: bi(
      "适合想重新确认自己最珍视的华语作品",
      "For revisiting the Chinese-language films you value most",
    ),
    kind: "category",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "在时间、欲望与擦肩而过之间作选择",
      "Choose among time, desire and all the near misses",
    ),
    recommendation: bi(
      "适合迷恋都市夜色、暧昧与独白的人",
      "For anyone drawn to neon nights, longing and inner monologues",
    ),
    kind: "director",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "童话、冒险与歌声，哪一部真正陪你长大",
      "Fairy tales, adventures and songs that grew up with you",
    ),
    recommendation: bi(
      "适合家庭观影，也适合检验童年滤镜",
      "Great for family movie night or testing childhood nostalgia",
    ),
    kind: "category",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "一起看过的故事，也许从来没有同一个第一名",
      "You shared the movies, but perhaps never the same number one",
    ),
    recommendation: bi(
      "适合情侣或好友各排一次，再交换结果",
      "Rank separately with a partner or friend, then compare",
    ),
    kind: "category",
    status: "active",
  ...
  },
  {
    ...
    tagline: bi(
      "童真、历史与奇观，一位大师的多面银幕",
      "Wonder, history and spectacle from a many-sided master",
    ),
    recommendation: bi(
      "适合在商业大片与严肃历史之间寻找偏爱",
      "For weighing blockbuster wonder against historical drama",
    ),
    kind: "director",
    status: "active",
...
const candidateSeeds: readonly FilmListSeed[] = [
  {
    ...
    tagline: bi(
      "对白、暴力与黑色幽默的高浓度对决",
      "Dialogue, violence and pitch-black humor collide",
    ),
    recommendation: bi(
      "适合喜欢类型混搭与强烈作者风格的观众",
      "For fans of genre collisions and unmistakable style",
    ),
    kind: "director",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "在宏大世界与幽暗人心之间沉浸",
      "Immense worlds meet the darkest corners of the mind",
    ),
    recommendation: bi(
      "适合偏爱氛围、尺度与慢燃张力的人",
      "For viewers who love atmosphere, scale and slow-burn tension",
    ),
    kind: "director",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "精密、冷峻，以及失控边缘的人性",
      "Precision, chill and human nature at the edge of control",
    ),
    recommendation: bi(
      "适合喜欢心理暗流与严密叙事的观众",
      "For lovers of psychological undercurrents and exacting craft",
    ),
    kind: "director",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "阶级寓言与类型快感总在同一镜头相遇",
      "Class allegory and genre thrills share every frame",
    ),
    recommendation: bi(
      "适合想在笑声、惊惧与社会观察间做选择",
      "For choosing among humor, dread and social observation",
    ),
    kind: "director",
    status: "candidate",
    topK: 6,
    ...
    movies: [
      ...
      ["玉子", "Okja", 2017],
      ["绑架门口狗", "Barking Dogs Never Bite", 2000],
  ...
  },
  {
    ...
    tagline: bi(
      "家人并非答案，而是一连串温柔的问题",
      "Family is not an answer, but a series of tender questions",
    ),
    recommendation: bi(
      "适合偏爱日常细节与克制情感的观众",
      "For viewers moved by everyday detail and quiet emotion",
    ),
    kind: "director",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "东西方、传统与欲望之间的细腻摆荡",
      "A delicate balance of East and West, tradition and desire",
    ),
    recommendation: bi(
      "适合欣赏文化碰撞与复杂情感的人",
      "For admirers of cultural tension and emotional complexity",
    ),
    kind: "director",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "浓烈色彩背后，是时代与个体的拉扯",
      "Behind the saturated colors, individuals wrestle with history",
    ),
    recommendation: bi(
      "适合比较早期现实主义与后期视觉奇观",
      "For contrasting early realism with later visual spectacle",
    ),
    kind: "director",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "从少年偶像到执念深重的银幕冒险家",
      "From teen idol to the screen's most driven adventurer",
    ),
    recommendation: bi(
      "适合在商业巨制与作者电影间选出最爱",
      "For choosing between blockbusters and auteur collaborations",
    ),
    kind: "actor",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "普通人的善意，也能撑起最辽阔的故事",
      "Ordinary decency can carry the grandest stories",
    ),
    recommendation: bi(
      "适合偏爱温暖、坚韧与经典叙事的观众",
      "For fans of warmth, resilience and classic storytelling",
    ),
    kind: "actor",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "优雅、锋利，也可以随时变成危险的谜",
      "Elegant, incisive and always capable of becoming a mystery",
    ),
    recommendation: bi(
      "适合欣赏角色跨度与精密表演的观众",
      "For admirers of range and finely calibrated performances",
    ),
    kind: "actor",
    status: "candidate",
    topK: 6,
    ...
    movies: [
      ["卡罗尔", "Carol", 2015],
      ["塔尔", "Tar", 2022],
      ["蓝色茉莉", "Blue Jasmine", 2013],
      ["伊丽莎白", "Elizabeth", 1998],
      ["飞行家", "The Aviator", 2004],
      ["本杰明·巴顿奇事", "The Curious Case of Benjamin Button", 2008],
      ["丑闻笔记", "Notes on a Scandal", 2006],
      ["玉面情魔", "Nightmare Alley", 2021],
      ["指环王：护戒使者", "The Lord of the Rings: The Fellowship of the Ring", 2001],
    ],
  },
  {
    ...
    recommendation: bi(
      "适合喜欢强势角色与道德困境的观众",
      "For fans of commanding characters and moral dilemmas",
    ),
    kind: "actor",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "沉默的眼神里，藏着江湖与都市的万千心事",
      "A quiet gaze carries a world of cities, longing and jianghu",
    ),
    recommendation: bi(
      "适合香港电影爱好者与表演细节控",
      "For Hong Kong cinema devotees and performance connoisseurs",
    ),
    kind: "actor",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "灵动与疏离，在不同年代留下同样耀眼的身影",
      "Vibrance and distance illuminate every era",
    ),
    recommendation: bi(
      "适合重温香港黄金时代与跨国作者电影",
      "For revisiting Hong Kong's golden age and global auteurs",
    ),
    kind: "actor",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "荒诞、愤怒与普通人的尊严都写在脸上",
      "Absurdity, anger and ordinary dignity in one unforgettable face",
    ),
    recommendation: bi(
      "适合借一位演员串起韩国电影二十年",
      "Trace two decades of Korean cinema through one great actor",
    ),
    kind: "actor",
    status: "candidate",
    topK: 8,
    ...
    movies: [
      ...
      ["汉江怪物", "The Host", 2006],
      ["共同警备区", "Joint Security Area", 2000],
      ["密阳", "Secret Sunshine", 2007],
      ["蝙蝠：血色情欲", "Thirst", 2009],
      ["观相", "The Face Reader", 2013],
    ],
  },
  {
    id: "zhou-xun",
    ...
    tagline: bi(
      "敏感、倔强与灵气，穿过华语银幕的不同面貌",
      "Sensitivity, defiance and spirit across Chinese-language cinema",
    ),
    recommendation: bi(
      "适合关注女性角色与华语作者电影的观众",
      "For viewers drawn to layered women and Chinese-language auteurs",
    ),
    kind: "actor",
    status: "candidate",
    topK: 6,
    ...
    movies: [
      ...
      ["香港有个荷里活", "Hollywood Hong Kong", 2001],
      ["明月几时有", "Our Time Will Come", 2017],
      ["你好，之华", "Last Letter", 2018],
      ["第十一回", "The Eleventh Chapter", 2019],
    ],
  },
  {
    id: "classic-scifi",
    ...
    tagline: bi(
      "从星海到意识边界，选择最打动你的未来",
      "From deep space to the edge of consciousness, choose your future",
    ),
    recommendation: bi(
      "适合检验你偏爱思想实验还是视觉奇观",
      "Discover whether you favor thought experiments or spectacle",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "证词、偏见与正义，谁能说服你",
      "Testimony, prejudice and justice: what will persuade you?",
    ),
    recommendation: bi(
      "适合喜欢密集对白、推理与道德抉择的人",
      "For fans of sharp dialogue, reasoning and moral choice",
    ),
    kind: "genre",
    status: "candidate",
    topK: 6,
  ...
  },
  {
    ...
    tagline: bi(
      "计划永远周密，人心永远是变数",
      "The plan is flawless; people are always the variable",
    ),
    recommendation: bi(
      "适合偏爱智斗、团队与灰色人物的观众",
      "For lovers of schemes, crews and morally gray characters",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "长大不是答案，而是那些终于敢做的选择",
      "Growing up is not an answer, but the choices you finally make",
    ),
    recommendation: bi(
      "适合寻找最像自己青春的那一部电影",
      "Find the film that feels most like your own youth",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "真正留下阴影的，未必是最响的尖叫",
      "The deepest shadow rarely comes from the loudest scream",
    ),
    recommendation: bi(
      "适合比较心理恐惧、怪物与超自然惊吓",
      "Compare psychological dread, monsters and the supernatural",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "不同笔触与技术，都能抵达同一种想象力",
      "Different hands and techniques reach the same boundless imagination",
    ),
    recommendation: bi(
      "适合走出单一厂牌，发现动画的更多可能",
      "Step beyond one studio and explore animation's full range",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
    ...
    movies: [
      ...
      ["机器人总动员", "WALL-E", 2008],
      ["玩具总动员", "Toy Story", 1995],
      ["我失去了身体", "I Lost My Body", 2019],
      ["凯尔经的秘密", "The Secret of Kells", 2009],
      ["与巴什尔跳华尔兹", "Waltz with Bashir", 2008],
  ...
  },
  {
    ...
    tagline: bi(
      "当对白不够用，就让旋律替人物回答",
      "When dialogue falls short, let the music answer",
    ),
    recommendation: bi(
      "适合在经典歌舞与现代音乐电影间选边",
      "Choose between golden-age musicals and modern reinventions",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
  ...
  },
  {
    ...
    tagline: bi(
      "比分会结束，拼到最后的人仍留在记忆里",
      "The score ends; the ones who fought on remain",
    ),
    recommendation: bi(
      "适合比较赛场激情、人物成长与真实传奇",
      "Compare competition, character growth and true-life legends",
    ),
    kind: "genre",
    status: "candidate",
    topK: 8,
